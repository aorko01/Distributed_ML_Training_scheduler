...
- Restart orchestration: 10 fake-command tests passed. ShellCheck and shell syntax
...
- Inspect actual GitHub-hosted Actions results
  for both Python unit versions, existing components and real network E2E. Local
  results alone do not establish CI compatibility or an actual fork-PR run.
